  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Home Appointments</h1>
          <p className="text-gray-600">Manage and view all your home appointment requests</p>
        </div>
...
export default HomeVisitAppointments;